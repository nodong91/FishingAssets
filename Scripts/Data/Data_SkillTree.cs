...
public class Data_SkillTree : ScriptableObject
{
    ...
    //Dictionary<Vector2Int, SkillStruct> dictSkills = new Dictionary<Vector2Int, SkillStruct>();
    ...
    //{
    //    dictSkills = new Dictionary<Vector2Int, SkillStruct>();
    //    skillList = new List<SkillStruct>();
